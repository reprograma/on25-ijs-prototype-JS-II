...
class Hamster extends Animal {
  ...
  consultar() {
    super.consultar();
    console.log(`${this.nome} está brincando para não ficar estressado.`);
  }

  brincar() {
    console.log(`${this.nome} está correndo na rodinha.`);
  }

  acariciar() {
    console.log(`${this.nome} está adorando os carinhos.`);
  }

  alimentar() {
    console.log(`${this.nome} está comendo sementinhas.`);
  }
}

const hamster = new Hamster("Iogurte", 1.5, "branco e laranja", []);
...
class Papagaio extends Animal {
  ...
  consultar() {
    super.consultar();
    console.log(`${this.nome} está falando enquanto você o consulta.`);
  }
  ...
  acariciar() {
    console.log(`${this.nome} está adorando os carinhos e falando.`);
  }

  alimentar() {
    console.log(`${this.nome} está comendo sementes e falando.`);
  }
}
